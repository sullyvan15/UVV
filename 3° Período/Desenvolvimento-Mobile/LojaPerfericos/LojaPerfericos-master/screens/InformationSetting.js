...
import CardSecurityLocation1 from "../components/CardSecurityLocation1";
import CardLanguage1 from "../components/CardLanguage1";
import Svg, { Path, Defs, Mask } from "react-native-svg";
import CardNotification1 from "../components/CardNotification1";
import Icon from "react-native-vector-icons/Ionicons";

function InformationSetting(props) {
  return (
    <View style={styles.root}>
      <View style={styles.bgStack}>
        <View style={styles.bg}>
          <View style={styles.description}></View>
          <CardSecurityLocation1
            style={styles.cardSecurityLocation1}
          ></CardSecurityLocation1>
        </View>
        <CardLanguage1 style={styles.cardLanguage1}></CardLanguage1>
        <Svg viewBox="-0.5 -0.5 379 4" style={styles.divider}>
          <Path
            strokeWidth={1}
            fill="transparent"
            ...
            fillOpacity={0.2}
            strokeOpacity={0.2}
            d="M0.00 1.00 L377.00 1.00 "
          ></Path>
        </Svg>
        <CardNotification1 style={styles.cardNotification1}></CardNotification1>
              ...
              <View style={styles.rect5Row}>
                <View style={styles.rect5}>
                  <View style={styles.clip2Stack}>
                    ...
                    >
                      <Defs>
                        <Mask id="i6WJfY" x={0} y={0} width={28} height={25}>
                          <Path
                            d="M0.00 0.00 L28.46 0.00 L28.46 25.92 L0.00 25.92 Z"
                            fill="white"
                          />
