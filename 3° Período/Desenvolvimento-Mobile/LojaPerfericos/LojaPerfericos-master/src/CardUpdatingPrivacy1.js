...
function CardUpdatingPrivacy1(props) {
  return (
    <View style={[styles.root, props.style]}>
      <View style={styles.rect}>
        <View style={styles.rectangle472}>
          <View style={styles.updatingPrivacy1}>
            <Text style={styles.updatingPrivacy2}>Atualizando Privacidade</Text>
            <View style={styles.frequencyRow}>
              <Text style={styles.frequency}>Frequência:</Text>
              <Text style={styles.style2}>70%</Text>
            </View>
            <View style={styles.slider}>
              <View style={styles.rectangle2Stack}>
                ...
                <Svg viewBox="-0 -0 18 18" style={styles.oval1}>
                  <Path
                    strokeWidth={0}
            ...
            <View style={styles.weekIntervalRow}>
              <Text style={styles.weekInterval}>Intervalo da semana:</Text>
              <Text style={styles.monSun}>Seg - Dom</Text>
            </View>
          </View>
        </View>
      </View>
...
export default CardUpdatingPrivacy1;
