  ...
  return (
    <View style={styles.root}>
      <View style={styles.button1Stack}>
        ...
        >
          <Text style={styles.signUpIfYoureN}>PRÓXIMO</Text>
        </TouchableOpacity>
        ...
        <View style={styles.password13}>
          <Text style={styles.password122}>Password</Text>
          <Svg
      ...
      <View style={styles.passwordStack}>
        <View style={styles.password}>
          <Text style={styles.password1}>Insira a senha</Text>
          <Svg
            viewBox="-0.5 -0.5 276.9995437982689 4.500909915843749"
            style={styles.path2}
          >
      ...
      <View style={styles.password2Stack}>
        <View style={styles.password2}>
          <Text style={styles.password12}>Confirme a senha</Text>
          <Svg
            viewBox="-0.5 -0.5 276.9995437982689 4.500909915843749"
            style={styles.path22}
          >
